...
export const ToolChip = ({
  ...
  return (
    ...
    >
      ...
      <motion.div className="flex items-center justify-center w-6 h-6 shrink-0" whileHover={{scale: 1.05}}>
        <Image
      ...
      <motion.span
        variants={{
          ...
          hover: { opacity: 1, width: "auto", paddingLeft:'2px', paddingRight: '5px', scale: 1.03 },
        }}
